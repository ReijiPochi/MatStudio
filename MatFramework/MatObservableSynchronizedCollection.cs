...
namespace MatFramework
{
    ...
    /// <summary>
    /// スレッドセーフな変更通知コレクションです。(from Livet)
    /// </summary>
    /// <typeparam name="T">コレクションアイテムの型</typeparam>
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1001:TypesThatOwnDisposableFieldsShouldBeDisposable")]
    [Serializable]
    public class MatObservableSynchronizedCollection<T> : IList<T>, ICollection, INotifyCollectionChanged, INotifyPropertyChanged
#if NET45
, IReadOnlyList<T>
#endif
    {
        ...
        /// デフォルトコンストラクタ
        /// </summary>
        public MatObservableSynchronizedCollection()
        {
            _list = new List<T>();
        }
        ...
        public MatObservableSynchronizedCollection(IEnumerable<T> source)
        {
